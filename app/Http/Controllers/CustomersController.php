...
class CustomersController extends Controller
{
     ...
     public function purchases($id)
     {
          ...
          $invoices = Invoice::where('customer_id', $id)->where('invoice_type', 'sale')->paginate(15);
     ...
     public function damages($id)
     {
          ...
          return view('customers.sales', ['user' => $user]);
     }

     public function bounces($id)
     {
          $user = Customer::find($id);
          $invoices = Invoice::where('customer_id', $id)->where('invoice_type', 'bounce')->paginate(15);
