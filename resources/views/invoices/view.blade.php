                        ...
                        @foreach ($invoiceItem as $item)
                            <tr id="{{ $item->item->barcode }}" class="items">
                                <td class="text-center d-none">
                                    <input type="hidden" name="item[id][]" class="form-control item_id w-100 border-0"
                                        readonly>
                                </td>
                                ...
                                <td style="width:15%" class="text-center">
                                    <input type="number" name="item[store_balance][]" value="{{ $item->store_balance }}"
                                        class="form-control store_balance w-100 border-0"
                                        data-balance="{{ $item->item->store_balance - $item->quantity }}" readonly>
                                </td>
                                <td class="text-center" {!! getVal($inv, 'invoice_type') != 'purchase' || !$show ? 'style="display: none;"' : '' !!}>
                                    <input type="number" name="item[purchasing_price][]"
                                        value="{{ $item->purchasing_price }}"
                                        class="form-control purchasing_price w-100 {!! getVal($inv, 'invoice_type') != 'purchase' ? 'border-0' : '' !!}"
                                        {!! getVal($inv, 'invoice_type') != 'purchase' ? 'readonly' : '' !!}>
                                </td>
