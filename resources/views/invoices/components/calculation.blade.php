            ...
            <form class="create-category" action="{{ route('ajax.createCategory') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group text-center">
                        ...
                        <input type="number" name="paid" class="form-control text-center paid" id="paid"
                            placeholder="00" autocomplete="off">
                    </div>
                    <div class="form-group text-center">
                        <label for="residual" class="control-label residual-text">{{ __('المتبقي') }}</label>
                        <input type="text" name="residual" class="form-control text-center residual" id="residual"
