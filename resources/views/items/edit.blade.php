            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('item.update', ['id' => $item->id]) }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="number" name="barcode" class="form-control text-center"
                                value="{{ $item->barcode }}" id="barcode" placeholder="00">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="title" class="form-control" id="title"
                                value="{{ $item->title }}" placeholder="{{ __('أكتب اسم الصنف اذا لم تتذكر الباركود') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <select name="model" class="form-control" id="model">
                                @if ($item->model)
                                    <option value="{{ $item->model }}" selected>{{ $item->models->title }}</option>
                                @else
              ...
              <select name="type" class="form-control" id="type">
              	<option value="" selected>{{ __('اختار حالة المنتج') }}...</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="warranty_period" value="{{ $item->warranty_period }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="number" name="purchasing_price" value="{{ $item->purchasing_price }}"
                                class="form-control text-center" id="purchasing_price" placeholder="00">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="number" name="selling_price" value="{{ $item->selling_price }}"
                                class="form-control text-center" id="selling_price" placeholder="00">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="number" name="average_price" value="{{ $item->average_price }}"
                                class="form-control text-center" id="average_price" placeholder="00">
                        </div>
                    </div>
