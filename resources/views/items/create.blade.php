...
@section('content')
  <div class="col-md-12 mt-3 position-sticky sticky-top">
      ...
      <div class="card-body">
              ...
              <div class="col-md-4">
                <input type="number" name="barcode" class="form-control text-center" id="barcode" placeholder="00" required>
			        </div>
              ...
              <div class="col-md-4">
                <input type="text" name="title" class="form-control" id="title" required placeholder="{{ __('أكتب اسم الصنف اذا لم تتذكر الباركود') }}">
					    </div>
					</div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-4">
                <input type="number" name="warranty_period" value="0" required class="form-control text-center" id="warranty_period" placeholder="{{ __('اكتب مدة ضمان المنتج هنا') }}">
					    </div>
					</div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-4">
                <input type="number" name="purchasing_price" required class="form-control text-center" id="purchasing_price" placeholder="00">
			        </div>
		      </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-4">
                <input type="number" name="selling_price" required class="form-control text-center" id="selling_price" placeholder="00">
			        </div>
		      </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-4">
                <input type="number" name="average_price" required class="form-control text-center" id="average_price" placeholder="00">
			        </div>
		      </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-4">
                <input type="number" name="store_balance" required class="form-control text-center" id="store_balance" placeholder="00">
			        </div>
		      </div>
