...
@section('content')
  <div class="col-md-12 mt-3">
		<form class="" action="{{ route('maintenance.store') }}" method="post">
			@csrf
			<div class="card card-primary">
				<div class="card-header">
					<h3 class="card-title">{{ __('استلام جهاز') }}</h3>
				</div>
				<!-- form start -->
				<div class="card-body form-horizontal">
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="text" name="agent_name" class="form-control" id="agent_name" placeholder="{{ __('أكتب هنا اسم العميل') }}">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<select name="malfunction[]" class="form-control" multiple id="malfunction">
								{{-- <option value="" selected>{{ __('اختار العطل') }}...</option> --}}
							</select>
						</div>
						<div class="col-md-2 p-0 d-flex">
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<textarea name="customer_complaint" class="form-control" id="customer_complaint" placeholder="{{ __('من فضلك أكتب شكوي العميل هنا') }}"></textarea>
						</div>
					</div>
