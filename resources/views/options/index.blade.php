      ...
      <div class="card-body">
          ...
          <div class="form-group row">
						...
						<div class="col-md-3">
							...
							<img id="preview-featured-image" src="{{ $src }}" class="rounded w-100" alt="Cinque Terre">
							<input id="logo" onchange="privewImage(this)" accept="image/*" type="file" name="logo">
						</div>
					</div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="text" name="shop_name" value="{{ getOption('shop_name') }}" class="form-control">
					    </div>
					</div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="text" name="phone" class="form-control" value="{{ getOption('phone') }}" id="phone">
					    </div>
					</div>
              ...
              <div class="col-md-6">
                <input type="text" name="facebook" value="{{ getOption('facebook') }}" class="form-control" id="facebook">
					    </div>
					</div>
              ...
              <div class="col-md-6">
                <input type="text" name="twitter" value="{{ getOption('twitter') }}" class="form-control" id="twitter">
					    </div>
					</div>
              ...
              <div class="col-md-6">
                <input type="text" name="whatsapp" value="{{ getOption('whatsapp') }}" class="form-control" id="whatsapp">
					    </div>
					</div>
