                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                <td>
                                    <a href="{{ route('user.sales', ['id' => $user->id]) }}">
                                        {{ $user->title }}
                                    </a>
                                </td>
                                <td>{{ $user->phone }}</td>
                    ...
                    <div class="modal-body row">
						...
						<div class="col-md-6">
                            <div class="form-group">
                                <label for="id" class="control-label small">{{ __('اسم') }}</label>
                                <input type="text" name="title" class="form-control" id="title"
                                    placeholder="{{ __('أكتب اسم العميل هنا.') }}" autocomplete="off">
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="id" class="control-label small">{{ __('رقم هاتف') }}</label>
